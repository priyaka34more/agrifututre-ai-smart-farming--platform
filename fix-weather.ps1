        ...
        <section className="risk-summary-card">
          ...
          <div className="risk-summary-grid">
            <div className="risk-summary-item">
              ...
              <span className="risk-summary-value" style={{ color: getStatusColor(metrics.rainRisk) }}>
                {metrics.rainRisk}
              </span>
            </div>
            <div className="risk-summary-item">
              ...
              <span className="risk-summary-value" style={{ color: getStatusColor(metrics.irrigation) }}>
                {metrics.irrigation}
              </span>
            </div>
            <div className="risk-summary-item">
              ...
              <span className="risk-summary-value" style={{ color: getStatusColor(metrics.disease) }}>
                {metrics.disease}
              </span>
            </div>
          </div>
...
$filePath = "d:\agrifutured\frontend\src\pages\Weather.jsx"
$utf8NoBom = New-Object System.Text.UTF8Encoding $false
[System.IO.File]::WriteAllText($filePath, $weatherJsx, $utf8NoBom)
Write-Host "✅ Weather.jsx fully fixed!"
